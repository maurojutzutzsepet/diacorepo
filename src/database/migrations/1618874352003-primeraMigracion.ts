...
export class primeraMigracion1618874352003 implements MigrationInterface {
    name = 'primeraMigracion1618874352003'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "quejas" ("id" int NOT NULL IDENTITY(1,1), "descripcion" varchar(250) NOT NULL, "createAt" datetime NOT NULL CONSTRAINT "DF_a7aed1ddc6c4586b5937d9bfbcc" DEFAULT CURRENT_TIMESTAMP, "updatedAt" datetime, "status" varchar(8) NOT NULL CONSTRAINT "DF_fca07bca6113f09e54e25bfb9f2" DEFAULT 'ACTIVE', "comercioId" int, CONSTRAINT "PK_382b57b1aeec364773f7f6c9a59" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "comercios" ("id" int NOT NULL IDENTITY(1,1), "nombre_comercio" varchar(60) NOT NULL, "telefono" varchar(20) NOT NULL, "direccion" varchar(100) NOT NULL, "email" varchar(40) NOT NULL, "municipio" int NOT NULL, "departamento" int NOT NULL, "region" int NOT NULL, "status" varchar(8) NOT NULL CONSTRAINT "DF_f60c40828b73e1c5f7b0d9313b8" DEFAULT 'ACTIVE', "createAt" datetime NOT NULL CONSTRAINT "DF_3d39d30b97ff2b71e3a94e7403a" DEFAULT CURRENT_TIMESTAMP, "updatedAt" datetime NOT NULL CONSTRAINT "DF_80f7410a45dacb8d0480f3f4ee3" DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_eebb0a6b0c9c94734483ccaf3ff" UNIQUE ("nombre_comercio"), CONSTRAINT "PK_f886203d76afacf779ac3a562c3" PRIMARY KEY ("id"))`);
